    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">| H u a u c h i n a n g o  | </a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li><a href="index.php"> &nbsp; &nbsp; &nbsp; Automotriz de la Sierra</a></li>
					<li><a data-toggle="modal" data-target="#uploadModal"> &nbsp; &nbsp; &nbsp; Espacio</a></li>
					<li class="active"><a href="items.php"> &nbsp; &nbsp; &nbsp; Espacio</a></li>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	?>
			 <div class="alert alert-info">
                          ...
                          <center> <h3><strong>Actualizar Refacción</strong> </h3></center>
    ...
    <tr>
        ...
        <td>
        	<center><p><img class="img img-thumbnail" src="item_images/<?php echo $item_image; ?>" height="600" width="600" /></p></center>
          ...
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:rgb(3,71,136);" class="modal-content">
              <div class="modal-header">
                ...
                <h2 style="color:white" class="modal-title" id="myModalLabel">Actualizar</h2>
              </div>
